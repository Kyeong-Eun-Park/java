...
//                new Thread(() -> request(strUrl)).start();
    ...
    public void request(String strUrl){
        ...
        // 응답 페이지를 입력스트림으로 읽어들여 문자열을 결합을 통해 저장할 변수 선언
    ...
    public void showMessage(String str){
        // 멀티쓰레딩 환경에서 메세지 출력을 위해 Handler 객체 활용
