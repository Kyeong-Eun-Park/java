...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // 메뉴 XML 파일을 메모리에 로딩하기 위해서는 MenuInflater 객체사용 필요
...
//        menuInflater.inflate(R.menu.menu, menu);
        ...
        // 자바코드로 옵션메뉴 생성하기
        // 메서드 파라미터로 전달되는 menu 객체의 add() 메서드를 호출하여 각 메뉴 항목 추가
    ...
    // 옵션메뉴의 항목 클릭 시 동작 처리를 위해서는 onOptionItemSelected() 메서드 오버라이딩 필수!
    @Override
...
//            case R.id.subItemRotate: iv.setRotation(iv.getRotation() + 30); break;
//            case R.id.subItemExpand: iv.setScaleX(iv.getScaleX() + 1); iv.setScaleY(iv.getScaleY() + 1); break;
//
//        }

        // 자바코드로 옵션메뉴 생성하여 switch문에서 비교할 때
        ...
        switch (item.getItemId()){
            ...
            case 4: iv.setRotation(iv.getRotation() + 30); break;
            case 5: iv.setScaleX(iv.getScaleX() + 1); iv.setScaleY(iv.getScaleY() + 1); break;
        }
