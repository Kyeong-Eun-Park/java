 ...
 * Generated at: 2023-03-06 07:03:27 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.jsp10_005fregular_005fexpression;
...
public final class join_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	var isDuplicateId = true; // 아이디 중복 여부를 저장할 변수 선언(true : 중복, false : 중복아님)\r\n");
      ...
      out.write("			// 버튼 우측 span 영역에 중복확인완료 표시\r\n");
      ...
      out.write("			\r\n");
      out.write("			// 만약, 중복체크 과정에서 중복이 발생했다고 가정(또는 아이디가 사용 불가능하다고 가정)\r\n");
      out.write("			// => 중복확인완료 표시를 제거하기 위해 isDuplicate 변수를 true 로 변경\r\n");
      ...
      out.write("		if(isDuplicateId) { // isDuplicateId == true (아이디 중복)\r\n");
      ...
      out.write("	<form action=\"requestPro3.jsp\" name=\"joinForm\" method=\"post\" onsubmit=\"return checkForm(this)\">\r\n");
      ...
      out.write("				<td>\r\n");
      out.write("					<textarea rows=\"10\" cols=\"60\" name=\"reason\" required=\"required\"></textarea>\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
