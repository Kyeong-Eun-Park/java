...
<nav class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-center" style="display:none" id="mySidebar">
  ...
  <a href="BoardWriteForm.bo" class="w3-bar-item w3-button">글쓰기</a>
  <a href="BoardList.bo" class="w3-bar-item w3-button">글목록</a>
...
<div class="w3-third">
  ...
  <p><b>최근 게시물 목록</b></p><br>
  <%-- 최근 게시물 목록 5개 출력하기 --%>
  <table>
  	<tr>
  		<th style="max-width: 200px">제목</th>
  		<th style="max-width: 80px">작성자</th>
  	</tr>
  <c:forEach var="board" items="${boardList }">
  	<tr>
  		<td><a href="BoardDetail.bo?board_num=${board.board_num }">${board.board_subject }</a></td>
